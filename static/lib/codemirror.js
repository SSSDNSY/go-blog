...
// This is CodeMirror (https://codemirror.net), a e editor
// implemented in JavaScript on top of the browser's DOM.
//
// You can find some technical background for some of the e below
...
(function (global, factory) {
    ...
    // Optimize some e when these features are not used.
    ...
    // specific stretches of text, and is used by the measuring e.
    ...
    function Display(place, doc, input, options) {
        ...
        // Will contain the actual e, positioned to cover the viewport.
        d.lineDiv = eltP("div", null, "CodeMirror-e");
    ...
    // generally horribly unpredictable, this e starts by measuring
    ...
    function onScrollWheel(cm, e) {
        ...
        // This hack (see related e in patchDisplay) makes sure the
    ...
    // default. User e or addons can define them. Unknown commands
    // are simply ignored.
    keyMap.pcDefault = {
    ...
    function keyName(event, noShift) {
        ...
        // so we'll use event.e when available (Chrome 48+, FF 38+, Safari 10.1+)
    ...
    // that user e is usually dealing with.
    ...
    ContentEditableInput.prototype.pollSelection = function () {
        ...
        // presses in a sane way, this e checks for when that happens
