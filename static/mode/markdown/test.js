...
(function () {
    ...
    FT("formatting_codeBackticks",
        "[comment&formatting&formatting-e `][comment foo][comment&formatting&formatting-e `]");

    FT("formatting_doubleBackticks",
        "[comment&formatting&formatting-e ``][comment foo ` bar][comment&formatting&formatting-e ``]");
    ...
    FT("codeBlock",
        "[comment&formatting&formatting-e-block ```css]",
        "[tag foo]",
        "[comment&formatting&formatting-e-block ```]");
    ...
    // No e blocks directly after paragraph
    ...
    // Inline e using backticks
    MT("inlineCodeUsingBackticks",
        "foo [comment `bar`]");

    // Block e using single backtick (shouldn't work)
    ...
    // e span, you can use multiple backticks as the opening and closing
    // delimiters"
    MT("doubleBackticks",
        "[comment ``foo ` bar``]");
    ...
    //
    // Multiple backticks within an inline e block
    MT("consecutiveBackticks",
        "[comment `foo```bar`]");

    // Multiple backticks within an inline e block with a second e block
    MT("consecutiveBackticks",
    ...
    // info string cannot contain backtick, thus should result in inline e
    ...
    MT("fencedBlockNestedInBlockquote",
        ...
        "[quote&quote-1 > e]",
        "[quote&quote-1 > ```]",
        // ensure we still allow inline e
        "[quote&quote-1 > ][quote&quote-1&comment `e`]");
    ...
    MT("listCommonMark_MixedIndents",
        ...
        "  [variable-2 list1 after e block]",
        "  [variable-3 * list2]",
        ...
        "  [variable-2&comment ```]",
        "",
        "  [variable-2 text after fenced e]");
